...
var aes = require('./aes').aes;
var rsa = require('./rsa').rsa;
var DJSON = require('./djson').DJSON;
...
exports.JWT = 
{
 ...
 parse: function(s, key)
 {
  var s=s+"", off = 0, c = "", hd = "", cs = "", sig = "",
      header = {alg:"", kid:""}, ai = 0, algs = this.algos,
  ...
  if(!DJSON.parse(r.header, header, {type: "object", props:[
   ...
   {name: "kid", value: {type: "string", props:[]}}
  ]})) return r;
  ...
  key.n = encoding.astr2hstr(encoding.base64_decode(key.n));
  key.e = encoding.astr2hstr(encoding.base64_decode(key.e));
